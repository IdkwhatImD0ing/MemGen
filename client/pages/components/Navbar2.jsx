...
export default function Navbar() {
  ...
  return (
    <nav className="flex text-white items-center justify-centers mr-10">
      ...
      <Link href="/inputdocuments" className="px-4 py-2 hover:bg-slate-700 rounded-md text-lg font-semibol">Input</Link>
      <Link href="/homepage" className="px-4 py-2 hover:bg-slate-700 rounded-md text-lg font-semibol mx-2">Home</Link>
